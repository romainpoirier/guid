...
class GUIDPlugin extends BasePlugin
{
    /**
    ...
    {
        return 'http://www.everythingisfun.eu';
    }
    ...
    {
        Craft::import('plugins.guid.twigextensions.GUIDTwigExtension');

        return new GUIDTwigExtension();
    }
